...
class _PromptDetails extends State<PromptDetails> {
  ...
  Widget _buildHeader() => Container(
    ...
    child: Column(
      children: [
        ...
        Text(widget.itemTitle, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: Colors.black87)),
      ],
    ),
  );
  ...
  Widget _buildPromptContent() => Container(
    ...
    child: Text(widget.content, style: const TextStyle(fontSize: 14, color: Colors.black87)),
  );
    ...
    child: ElevatedButton(
      ...
      child: const Row(
        ...
        children: [
          ...
          SizedBox(width: 8),
          Text('Send', style: TextStyle(fontSize: 16, color: Colors.white, fontWeight: FontWeight.w600)),
        ],
      ),
    ),
  );
    ...
    child: ElevatedButton(
      onPressed: () async {
        ...
        if (widget.promptId.isEmpty) {
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Invalid prompt ID.')));
          return;
        }
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(success ? 'Prompt updated.' : 'Failed to update prompt.')));
  ...
  Widget _buildTextField(String label, TextEditingController controller, {bool isRequired = false}) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Row(
        children: [
